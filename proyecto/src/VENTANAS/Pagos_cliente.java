 ...
 * @author Paula
 */
public class Pagos_cliente extends javax.swing.JDialog {

    /**
     * Creates new form Pagos_cliente
     */
    public Pagos_cliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
   ...
   this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Pagos_cliente dialog = new Pagos_cliente(new javax.swing.JFrame(), true);
